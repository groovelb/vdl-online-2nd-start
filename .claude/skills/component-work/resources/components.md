...
- ProductCard: Lumenstate 제품 시그니처 카드. Day/Night 쌍 이미지 + timeValue 블렌드, 영문 타이틀 + 한글 해설 + 빛 메타(lux/kelvin/form), Framer Motion layoutId로 Shared Element 전이 준비 (`components/card/ProductCard.jsx`)
