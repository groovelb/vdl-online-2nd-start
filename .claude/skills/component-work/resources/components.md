...
- HeroSection: Lumenstate 랜딩 히어로. LineGrid 2:1 수평 분할(좌: arc-lamp-living / 우: arch-light-gallery)에 Day/Night 쌍 이미지 배치, TimelineContext 구독해 smoothstep 블렌드, 기본 100vh 높이 (`components/templates/HeroSection.jsx`)
